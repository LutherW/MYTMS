...
namespace DTcms.BLL
{
    public partial class Address
    {
        ...
        private readonly DTcms.DAL.Address dal = new DTcms.DAL.Address ();
        public Address()
        { }
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        //public Model.Address GetModelByCache(int Id)
        //{

        //    string CacheKey = "mtms_Model.AddressModel-" + Id;
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.Address> GetModelList(string strWhere)
        {
