...
namespace DTcms.Web.admin.Business
{
    public partial class receipt_register_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                TreeBind(""); //绑定类别
                RptBind("A.Status=1" + CombSqlTxt(_carNumber, _beginTime, _endTime, this.keywords), "BackTime desc");
            }
        }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("receipt_register_list.aspx", "carNumber={0}&beginTime={1}&endTime={2}&keywords={3}&page={4}",
        ...
        protected string CombSqlTxt(string carNumber, string beginTime, string endTime, string _keywords)
        {
            ...
            {
                strTemp.Append(" and A.BackTime>='" + beginTime + "'");
            }
            if (!string.IsNullOrEmpty(endTime))
            {
                strTemp.Append(" and A.BackTime<='" + endTime + "'");
            }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("receipt_register_list.aspx", "carNumber={0}&beginTime={1}&endTime={2}&keywords={3}",
