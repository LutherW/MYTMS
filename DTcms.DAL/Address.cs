...
namespace DTcms.DAL
{
    public partial class Address
    {
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from mtms_Address");
            strSql.Append(" where ");
            strSql.Append(" Id = @Id  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into mtms_Address(");
            strSql.Append("Name,CategoryName,Code");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update mtms_Address set ");
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from mtms_Address ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM mtms_Address");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
