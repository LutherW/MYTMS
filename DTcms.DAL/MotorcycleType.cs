...
namespace DTcms.DAL
{
    public partial class MotorcycleType
    {
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from mtms_MotorcycleType");
            strSql.Append(" where ");
            strSql.Append(" Id = @Id  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into mtms_MotorcycleType(");
            strSql.Append("Name");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update mtms_MotorcycleType set ");
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from mtms_MotorcycleType ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        public Model.MotorcycleType GetModel(int Id)
        {
            ...
            strSql.Append("  from mtms_MotorcycleType ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM mtms_MotorcycleType");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
